...
{
	//logo
	LogoSV[0] = TextDrawCreate(12.083335, 430.074127, "CZYCITY.NET");
...
CreatePokerGUI(playerid)
{
	...
	PlayerPokerUI[playerid][43] = CreatePlayerTextDraw(playerid, 589.000000, 396.000000, "GTAV.NET");
...
public LoadTextDraws()
{
    ...
    MainMenuTxtdraw[0] = TextDrawCreate(0.000000, 0.000000, "loadsc13:loadsc13");
    TextDrawLetterSize(MainMenuTxtdraw[0], 0.000000, 0.000000);
    TextDrawTextSize(MainMenuTxtdraw[0], 640.000000, 448.000000);
    ...
    TextDrawFont(MainMenuTxtdraw[0], 4);
	...
	NoticeTxtdraw[1] = TextDrawCreate(317.000000, 174.000000, "GTAV.NET - Ket Noi");
	...
	TutTxtdraw[9] = TextDrawCreate(175.000000, 203.000000, "be sure to visit us and sign up on our forums at ~y~www.GTAV.NET~w~ - we");
	...
	TutTxtdraw[12] = TextDrawCreate(175.000000, 255.000000, "check it all out at ~y~GTAV.NET~w~, it helps keep this server up and");
	...
	TutTxtdraw[29] = TextDrawCreate(175.000000, 171.000000, "forums at ~y~www.GTAV.NET~w~.");
	...
	TutTxtdraw[38] = TextDrawCreate(175.000000, 171.000000, "apply on our forums at ~y~www.GTAV.NET~w~.");
	...
	TutTxtdraw[44] = TextDrawCreate(175.000000, 171.000000, "this faction, apply on our forums at ~y~www.GTAV.NET~w~.");
	...
	TutTxtdraw[50] = TextDrawCreate(175.000000, 171.000000, "this faction, apply on our forums at ~y~GTAV.NET~w~.");
	...
	TutTxtdraw[56] = TextDrawCreate(175.000000, 171.000000, "at ~y~www.GTAV.NET~w~.");
	...
	TutTxtdraw[88] = TextDrawCreate(175.000000, 141.000000, "We operate a 24/7 E-Store at ~y~GTAV.NET~w~, you can purchase Vehicles,");
	...
	TutTxtdraw[112] = TextDrawCreate(175.000000, 174.000000, "check out ~y~www.GTAV.NET~w~.");
...
{
    // thong tin
	ThongTin[0][playerid] = CreatePlayerTextDraw(playerid, 151.199996, 120.960006, "LD_SPAC:white");
	PlayerTextDrawLetterSize(playerid, ThongTin[0][playerid], 0.000000, 0.000000);
	PlayerTextDrawTextSize(playerid, ThongTin[0][playerid], 337.599945, 21.653324);
	PlayerTextDrawAlignment(playerid, ThongTin[0][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[0][playerid], 65535);
	PlayerTextDrawSetShadow(playerid, ThongTin[0][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[0][playerid], 0);
	PlayerTextDrawFont(playerid, ThongTin[0][playerid], 4);

	ThongTin[1][playerid] = CreatePlayerTextDraw(playerid, 318.399841, 123.946655, "Thong tin nhan vat");
	PlayerTextDrawLetterSize(playerid, ThongTin[1][playerid], 0.449999, 1.600000);
	PlayerTextDrawAlignment(playerid, ThongTin[1][playerid], 2);
	PlayerTextDrawColor(playerid, ThongTin[1][playerid], -1);
	PlayerTextDrawSetShadow(playerid, ThongTin[1][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[1][playerid], 1);
	PlayerTextDrawBackgroundColor(playerid, ThongTin[1][playerid], 255);
	PlayerTextDrawFont(playerid, ThongTin[1][playerid], 3);
	PlayerTextDrawSetProportional(playerid, ThongTin[1][playerid], 1);

	ThongTin[2][playerid] = CreatePlayerTextDraw(playerid, 151.199996, 144.106658, "LD_SPAC:white");
	PlayerTextDrawLetterSize(playerid, ThongTin[2][playerid], 0.000000, 0.000000);
	PlayerTextDrawTextSize(playerid, ThongTin[2][playerid], 337.600036, 195.626678);
	PlayerTextDrawAlignment(playerid, ThongTin[2][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[2][playerid], 255);
	PlayerTextDrawSetShadow(playerid, ThongTin[2][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[2][playerid], 0);
	PlayerTextDrawFont(playerid, ThongTin[2][playerid], 4);

	ThongTin[3][playerid] = CreatePlayerTextDraw(playerid, 157.600021, 149.333358, "LD_SPAC:white");
	PlayerTextDrawLetterSize(playerid, ThongTin[3][playerid], 0.000000, 0.000000);
	PlayerTextDrawTextSize(playerid, ThongTin[3][playerid], 99.199989, 108.266647);
	PlayerTextDrawAlignment(playerid, ThongTin[3][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[3][playerid], -1);
	PlayerTextDrawUseBox(playerid, ThongTin[3][playerid], true);
	PlayerTextDrawBoxColor(playerid, ThongTin[3][playerid], 0);
	PlayerTextDrawSetShadow(playerid, ThongTin[3][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[3][playerid], 0);
	PlayerTextDrawFont(playerid, ThongTin[3][playerid], 5);

	ThongTin[4][playerid] = CreatePlayerTextDraw(playerid, 262.399993, 144.106658, "LD_SPAC:white");
	PlayerTextDrawLetterSize(playerid, ThongTin[4][playerid], 0.000000, 0.000000);
	PlayerTextDrawTextSize(playerid, ThongTin[4][playerid], 2.399993, 195.626678);
	PlayerTextDrawAlignment(playerid, ThongTin[4][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[4][playerid], -65281);
	PlayerTextDrawSetShadow(playerid, ThongTin[4][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[4][playerid], 0);
	PlayerTextDrawFont(playerid, ThongTin[4][playerid], 4);

	ThongTin[5][playerid] = CreatePlayerTextDraw(playerid, 156.800003, 257.600006, "LD_SPAC:white");
	PlayerTextDrawLetterSize(playerid, ThongTin[5][playerid], 0.000000, 0.000000);
	PlayerTextDrawTextSize(playerid, ThongTin[5][playerid], 100.000000, 1.493316);
	PlayerTextDrawAlignment(playerid, ThongTin[5][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[5][playerid], 65535);
	PlayerTextDrawSetShadow(playerid, ThongTin[5][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[5][playerid], 0);
	PlayerTextDrawFont(playerid, ThongTin[5][playerid], 4);

	ThongTin[6][playerid] = CreatePlayerTextDraw(playerid, 156.199996, 147.346603, "LD_SPAC:white");
	PlayerTextDrawLetterSize(playerid, ThongTin[6][playerid], 0.000000, 0.000000);
	PlayerTextDrawTextSize(playerid, ThongTin[6][playerid], 100.000000, 1.493316);
	PlayerTextDrawAlignment(playerid, ThongTin[6][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[6][playerid], 65535);
	PlayerTextDrawSetShadow(playerid, ThongTin[6][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[6][playerid], 0);
	PlayerTextDrawFont(playerid, ThongTin[6][playerid], 4);

	ThongTin[7][playerid] = CreatePlayerTextDraw(playerid, 156.800003, 148.586669, "LD_SPAC:white");
	PlayerTextDrawLetterSize(playerid, ThongTin[7][playerid], 0.000000, 0.000000);
	PlayerTextDrawTextSize(playerid, ThongTin[7][playerid], 1.600006, 110.506652);
	PlayerTextDrawAlignment(playerid, ThongTin[7][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[7][playerid], 65535);
	PlayerTextDrawSetShadow(playerid, ThongTin[7][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[7][playerid], 0);
	PlayerTextDrawFont(playerid, ThongTin[7][playerid], 4);

	ThongTin[8][playerid] = CreatePlayerTextDraw(playerid, 254.600036, 147.346679, "LD_SPAC:white");
	PlayerTextDrawLetterSize(playerid, ThongTin[8][playerid], 0.000000, 0.000000);
	PlayerTextDrawTextSize(playerid, ThongTin[8][playerid], 1.600006, 110.506652);
	PlayerTextDrawAlignment(playerid, ThongTin[8][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[8][playerid], 65535);
	PlayerTextDrawSetShadow(playerid, ThongTin[8][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[8][playerid], 0);
	PlayerTextDrawFont(playerid, ThongTin[8][playerid], 4);

	ThongTin[9][playerid] = CreatePlayerTextDraw(playerid, 274.399993, 167.253326, "LD_SPAC:white");
	PlayerTextDrawLetterSize(playerid, ThongTin[9][playerid], 0.000000, 0.000000);
	PlayerTextDrawTextSize(playerid, ThongTin[9][playerid], 204.799987, 2.986663);
	PlayerTextDrawAlignment(playerid, ThongTin[9][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[9][playerid], -1);
	PlayerTextDrawSetShadow(playerid, ThongTin[9][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[9][playerid], 0);
	PlayerTextDrawFont(playerid, ThongTin[9][playerid], 4);

	ThongTin[10][playerid] = CreatePlayerTextDraw(playerid, 273.799987, 192.893447, "LD_SPAC:white");
	PlayerTextDrawLetterSize(playerid, ThongTin[10][playerid], 0.000000, 0.000000);
	PlayerTextDrawTextSize(playerid, ThongTin[10][playerid], 204.799987, 2.986663);
	PlayerTextDrawAlignment(playerid, ThongTin[10][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[10][playerid], -1);
	PlayerTextDrawSetShadow(playerid, ThongTin[10][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[10][playerid], 0);
	PlayerTextDrawFont(playerid, ThongTin[10][playerid], 4);

	ThongTin[11][playerid] = CreatePlayerTextDraw(playerid, 274.000000, 220.026901, "LD_SPAC:white");
	PlayerTextDrawLetterSize(playerid, ThongTin[11][playerid], 0.000000, 0.000000);
	PlayerTextDrawTextSize(playerid, ThongTin[11][playerid], 204.799987, 2.986663);
	PlayerTextDrawAlignment(playerid, ThongTin[11][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[11][playerid], -1);
	PlayerTextDrawSetShadow(playerid, ThongTin[11][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[11][playerid], 0);
	PlayerTextDrawFont(playerid, ThongTin[11][playerid], 4);

	ThongTin[12][playerid] = CreatePlayerTextDraw(playerid, 274.199981, 246.413635, "LD_SPAC:white");
	PlayerTextDrawLetterSize(playerid, ThongTin[12][playerid], 0.000000, 0.000000);
	PlayerTextDrawTextSize(playerid, ThongTin[12][playerid], 204.799987, 2.986663);
	PlayerTextDrawAlignment(playerid, ThongTin[12][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[12][playerid], -1);
	PlayerTextDrawSetShadow(playerid, ThongTin[12][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[12][playerid], 0);
	PlayerTextDrawFont(playerid, ThongTin[12][playerid], 4);

	ThongTin[13][playerid] = CreatePlayerTextDraw(playerid, 274.399993, 273.547149, "LD_SPAC:white");
	PlayerTextDrawLetterSize(playerid, ThongTin[13][playerid], 0.000000, 0.000000);
	PlayerTextDrawTextSize(playerid, ThongTin[13][playerid], 204.799987, 2.986663);
	PlayerTextDrawAlignment(playerid, ThongTin[13][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[13][playerid], -1);
	PlayerTextDrawSetShadow(playerid, ThongTin[13][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[13][playerid], 0);
	PlayerTextDrawFont(playerid, ThongTin[13][playerid], 4);

	ThongTin[14][playerid] = CreatePlayerTextDraw(playerid, 273.799987, 299.934020, "LD_SPAC:white");
	PlayerTextDrawLetterSize(playerid, ThongTin[14][playerid], 0.000000, 0.000000);
	PlayerTextDrawTextSize(playerid, ThongTin[14][playerid], 204.799987, 2.986663);
	PlayerTextDrawAlignment(playerid, ThongTin[14][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[14][playerid], -1);
	PlayerTextDrawSetShadow(playerid, ThongTin[14][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[14][playerid], 0);
	PlayerTextDrawFont(playerid, ThongTin[14][playerid], 4);

	ThongTin[15][playerid] = CreatePlayerTextDraw(playerid, 273.999969, 324.080871, "LD_SPAC:white");
	PlayerTextDrawLetterSize(playerid, ThongTin[15][playerid], 0.000000, 0.000000);
	PlayerTextDrawTextSize(playerid, ThongTin[15][playerid], 204.799987, 2.986663);
	PlayerTextDrawAlignment(playerid, ThongTin[15][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[15][playerid], -1);
	PlayerTextDrawSetShadow(playerid, ThongTin[15][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[15][playerid], 0);
	PlayerTextDrawFont(playerid, ThongTin[15][playerid], 4);

	ThongTin[16][playerid] = CreatePlayerTextDraw(playerid, 274.400146, 151.573394, ""); //Ten
	PlayerTextDrawLetterSize(playerid, ThongTin[16][playerid], 0.449999, 1.600000);
	PlayerTextDrawAlignment(playerid, ThongTin[16][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[16][playerid], -1);
	PlayerTextDrawSetShadow(playerid, ThongTin[16][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[16][playerid], 1);
	PlayerTextDrawBackgroundColor(playerid, ThongTin[16][playerid], 51);
	PlayerTextDrawFont(playerid, ThongTin[16][playerid], 3);
	PlayerTextDrawSetProportional(playerid, ThongTin[16][playerid], 1);

	ThongTin[17][playerid] = CreatePlayerTextDraw(playerid, 274.400054, 176.959991, ""); //GioiTinh
	PlayerTextDrawLetterSize(playerid, ThongTin[17][playerid], 0.449999, 1.600000);
	PlayerTextDrawAlignment(playerid, ThongTin[17][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[17][playerid], -1);
	PlayerTextDrawSetShadow(playerid, ThongTin[17][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[17][playerid], 1);
	PlayerTextDrawBackgroundColor(playerid, ThongTin[17][playerid], 51);
	PlayerTextDrawFont(playerid, ThongTin[17][playerid], 3);
	PlayerTextDrawSetProportional(playerid, ThongTin[17][playerid], 1);

	ThongTin[18][playerid] = CreatePlayerTextDraw(playerid, 274.400115, 203.839950, ""); //NgaySinh
	PlayerTextDrawLetterSize(playerid, ThongTin[18][playerid], 0.449999, 1.600000);
	PlayerTextDrawAlignment(playerid, ThongTin[18][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[18][playerid], -1);
	PlayerTextDrawSetShadow(playerid, ThongTin[18][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[18][playerid], 1);
	PlayerTextDrawBackgroundColor(playerid, ThongTin[18][playerid], 51);
	PlayerTextDrawFont(playerid, ThongTin[18][playerid], 3);
	PlayerTextDrawSetProportional(playerid, ThongTin[18][playerid], 1);

	ThongTin[19][playerid] = CreatePlayerTextDraw(playerid, 274.400115, 229.973327, ""); //QuocTich
	PlayerTextDrawLetterSize(playerid, ThongTin[19][playerid], 0.449999, 1.600000);
	PlayerTextDrawAlignment(playerid, ThongTin[19][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[19][playerid], -1);
	PlayerTextDrawSetShadow(playerid, ThongTin[19][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[19][playerid], 1);
	PlayerTextDrawBackgroundColor(playerid, ThongTin[19][playerid], 51);
	PlayerTextDrawFont(playerid, ThongTin[19][playerid], 3);
	PlayerTextDrawSetProportional(playerid, ThongTin[19][playerid], 1);

	ThongTin[20][playerid] = CreatePlayerTextDraw(playerid, 274.400146, 257.600067, ""); //job1
	PlayerTextDrawLetterSize(playerid, ThongTin[20][playerid], 0.449999, 1.600000);
	PlayerTextDrawAlignment(playerid, ThongTin[20][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[20][playerid], -1);
	PlayerTextDrawSetShadow(playerid, ThongTin[20][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[20][playerid], 1);
	PlayerTextDrawBackgroundColor(playerid, ThongTin[20][playerid], 51);
	PlayerTextDrawFont(playerid, ThongTin[20][playerid], 3);
	PlayerTextDrawSetProportional(playerid, ThongTin[20][playerid], 1);

	ThongTin[21][playerid] = CreatePlayerTextDraw(playerid, 274.399993, 283.733337, ""); //job2
	PlayerTextDrawLetterSize(playerid, ThongTin[21][playerid], 0.449999, 1.600000);
	PlayerTextDrawAlignment(playerid, ThongTin[21][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[21][playerid], -1);
	PlayerTextDrawSetShadow(playerid, ThongTin[21][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[21][playerid], 1);
	PlayerTextDrawBackgroundColor(playerid, ThongTin[21][playerid], 51);
	PlayerTextDrawFont(playerid, ThongTin[21][playerid], 3);
	PlayerTextDrawSetProportional(playerid, ThongTin[21][playerid], 1);

	ThongTin[22][playerid] = CreatePlayerTextDraw(playerid, 274.399963, 308.373321, ""); //Level
	PlayerTextDrawLetterSize(playerid, ThongTin[22][playerid], 0.449999, 1.600000);
	PlayerTextDrawAlignment(playerid, ThongTin[22][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[22][playerid], -1);
	PlayerTextDrawSetShadow(playerid, ThongTin[22][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[22][playerid], 1);
	PlayerTextDrawBackgroundColor(playerid, ThongTin[22][playerid], 51);
	PlayerTextDrawFont(playerid, ThongTin[22][playerid], 3);
	PlayerTextDrawSetProportional(playerid, ThongTin[22][playerid], 1);

	ThongTin[23][playerid] = CreatePlayerTextDraw(playerid, 262.399993, 341.973327, "LD_SPAC:white");
	PlayerTextDrawLetterSize(playerid, ThongTin[23][playerid], 0.000000, 0.000000);
	PlayerTextDrawTextSize(playerid, ThongTin[23][playerid], 226.400024, 24.640014);
	PlayerTextDrawAlignment(playerid, ThongTin[23][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[23][playerid], 255);
	PlayerTextDrawSetShadow(playerid, ThongTin[23][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[23][playerid], 0);
	PlayerTextDrawFont(playerid, ThongTin[23][playerid], 4);

	ThongTin[24][playerid] = CreatePlayerTextDraw(playerid, 329.599975, 344.213317, "LD_SPAC:white");
	PlayerTextDrawLetterSize(playerid, ThongTin[24][playerid], 0.000000, 0.000000);
	PlayerTextDrawTextSize(playerid, ThongTin[24][playerid], 4.000030, 20.160003);
	PlayerTextDrawAlignment(playerid, ThongTin[24][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[24][playerid], 8388863);
	PlayerTextDrawSetShadow(playerid, ThongTin[24][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[24][playerid], 0);
	PlayerTextDrawFont(playerid, ThongTin[24][playerid], 4);

	ThongTin[25][playerid] = CreatePlayerTextDraw(playerid, 404.200042, 343.719970, "LD_SPAC:white");
	PlayerTextDrawLetterSize(playerid, ThongTin[25][playerid], 0.000000, 0.000000);
	PlayerTextDrawTextSize(playerid, ThongTin[25][playerid], 4.000030, 20.160003);
	PlayerTextDrawAlignment(playerid, ThongTin[25][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[25][playerid], 8388863);
	PlayerTextDrawSetShadow(playerid, ThongTin[25][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[25][playerid], 0);
	PlayerTextDrawFont(playerid, ThongTin[25][playerid], 4);

	ThongTin[26][playerid] = CreatePlayerTextDraw(playerid, 412.000000, 344.959991, "LD_SPAC:white"); // dong
	PlayerTextDrawLetterSize(playerid, ThongTin[26][playerid], 0.000000, 0.000000);
	PlayerTextDrawTextSize(playerid, ThongTin[26][playerid], 73.600006, 18.666687);
	PlayerTextDrawAlignment(playerid, ThongTin[26][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[26][playerid], -16776961);
	PlayerTextDrawSetShadow(playerid, ThongTin[26][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[26][playerid], 0);
	PlayerTextDrawFont(playerid, ThongTin[26][playerid], 4);
	PlayerTextDrawSetSelectable(playerid, ThongTin[26][playerid], true);

	ThongTin[27][playerid] = CreatePlayerTextDraw(playerid, 430.399841, 346.453308, "Dong");
	PlayerTextDrawLetterSize(playerid, ThongTin[27][playerid], 0.449999, 1.600000);
	PlayerTextDrawAlignment(playerid, ThongTin[27][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[27][playerid], -1);
	PlayerTextDrawSetShadow(playerid, ThongTin[27][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[27][playerid], 1);
	PlayerTextDrawBackgroundColor(playerid, ThongTin[27][playerid], 51);
	PlayerTextDrawFont(playerid, ThongTin[27][playerid], 3);
	PlayerTextDrawSetProportional(playerid, ThongTin[27][playerid], 1);

	ThongTin[28][playerid] = CreatePlayerTextDraw(playerid, 264.799987, 344.959991, "LD_SPAC:white");
	PlayerTextDrawLetterSize(playerid, ThongTin[28][playerid], 0.000000, 0.000000);
	PlayerTextDrawTextSize(playerid, ThongTin[28][playerid], 62.400024, 18.666687);
	PlayerTextDrawAlignment(playerid, ThongTin[28][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[28][playerid], 16711935);
	PlayerTextDrawSetShadow(playerid, ThongTin[28][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[28][playerid], 0);
	PlayerTextDrawFont(playerid, ThongTin[28][playerid], 4);
	PlayerTextDrawSetSelectable(playerid, ThongTin[28][playerid], true);

	ThongTin[29][playerid] = CreatePlayerTextDraw(playerid, 336.000000, 344.959991, "LD_SPAC:white");
	PlayerTextDrawLetterSize(playerid, ThongTin[29][playerid], 0.000000, 0.000000);
	PlayerTextDrawTextSize(playerid, ThongTin[29][playerid], 66.400024, 18.666687);
	PlayerTextDrawAlignment(playerid, ThongTin[29][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[29][playerid], 16711935);
	PlayerTextDrawSetShadow(playerid, ThongTin[29][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[29][playerid], 0);
	PlayerTextDrawFont(playerid, ThongTin[29][playerid], 4);
	PlayerTextDrawSetSelectable(playerid, ThongTin[29][playerid], true);

	ThongTin[30][playerid] = CreatePlayerTextDraw(playerid, 272.800109, 346.453338, "Truoc");
	PlayerTextDrawLetterSize(playerid, ThongTin[30][playerid], 0.449999, 1.600000);
	PlayerTextDrawAlignment(playerid, ThongTin[30][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[30][playerid], -1);
	PlayerTextDrawSetShadow(playerid, ThongTin[30][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[30][playerid], 1);
	PlayerTextDrawBackgroundColor(playerid, ThongTin[30][playerid], 51);
	PlayerTextDrawFont(playerid, ThongTin[30][playerid], 3);
	PlayerTextDrawSetProportional(playerid, ThongTin[30][playerid], 1);

	ThongTin[31][playerid] = CreatePlayerTextDraw(playerid, 355.199768, 346.453369, "Sau");
	PlayerTextDrawLetterSize(playerid, ThongTin[31][playerid], 0.449999, 1.600000);
	PlayerTextDrawAlignment(playerid, ThongTin[31][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[31][playerid], -1);
	PlayerTextDrawSetShadow(playerid, ThongTin[31][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[31][playerid], 1);
	PlayerTextDrawBackgroundColor(playerid, ThongTin[31][playerid], 51);
	PlayerTextDrawFont(playerid, ThongTin[31][playerid], 3);
	PlayerTextDrawSetProportional(playerid, ThongTin[31][playerid], 1);

	ThongTin[32][playerid] = CreatePlayerTextDraw(playerid, 159.199996, 275.520019, "LD_SPAC:white");
	PlayerTextDrawLetterSize(playerid, ThongTin[32][playerid], 0.000000, 0.000000);
	PlayerTextDrawTextSize(playerid, ThongTin[32][playerid], 95.200012, 2.239990);
	PlayerTextDrawAlignment(playerid, ThongTin[32][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[32][playerid], -1);
	PlayerTextDrawSetShadow(playerid, ThongTin[32][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[32][playerid], 0);
	PlayerTextDrawFont(playerid, ThongTin[32][playerid], 4);

	ThongTin[33][playerid] = CreatePlayerTextDraw(playerid, 158.599990, 293.693450, "LD_SPAC:white");
	PlayerTextDrawLetterSize(playerid, ThongTin[33][playerid], 0.000000, 0.000000);
	PlayerTextDrawTextSize(playerid, ThongTin[33][playerid], 95.200012, 2.239990);
	PlayerTextDrawAlignment(playerid, ThongTin[33][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[33][playerid], -1);
	PlayerTextDrawSetShadow(playerid, ThongTin[33][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[33][playerid], 0);
	PlayerTextDrawFont(playerid, ThongTin[33][playerid], 4);

	ThongTin[34][playerid] = CreatePlayerTextDraw(playerid, 157.999984, 311.866943, "LD_SPAC:white");
	PlayerTextDrawLetterSize(playerid, ThongTin[34][playerid], 0.000000, 0.000000);
	PlayerTextDrawTextSize(playerid, ThongTin[34][playerid], 95.200012, 2.239990);
	PlayerTextDrawAlignment(playerid, ThongTin[34][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[34][playerid], -1);
	PlayerTextDrawSetShadow(playerid, ThongTin[34][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[34][playerid], 0);
	PlayerTextDrawFont(playerid, ThongTin[34][playerid], 4);

	ThongTin[35][playerid] = CreatePlayerTextDraw(playerid, 158.199981, 330.040435, "LD_SPAC:white");
	PlayerTextDrawLetterSize(playerid, ThongTin[35][playerid], 0.000000, 0.000000);
	PlayerTextDrawTextSize(playerid, ThongTin[35][playerid], 95.200012, 2.239990);
	PlayerTextDrawAlignment(playerid, ThongTin[35][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[35][playerid], -1);
	PlayerTextDrawSetShadow(playerid, ThongTin[35][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[35][playerid], 0);
	PlayerTextDrawFont(playerid, ThongTin[35][playerid], 4);

	ThongTin[36][playerid] = CreatePlayerTextDraw(playerid, 159.199890, 259.839935, ""); //Advisor
	PlayerTextDrawLetterSize(playerid, ThongTin[36][playerid], 0.449999, 1.600000);
	PlayerTextDrawAlignment(playerid, ThongTin[36][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[36][playerid], -1);
	PlayerTextDrawSetShadow(playerid, ThongTin[36][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[36][playerid], 1);
	PlayerTextDrawBackgroundColor(playerid, ThongTin[36][playerid], 51);
	PlayerTextDrawFont(playerid, ThongTin[36][playerid], 3);
	PlayerTextDrawSetProportional(playerid, ThongTin[36][playerid], 1);

	ThongTin[37][playerid] = CreatePlayerTextDraw(playerid, 158.399978, 314.346649, ""); //VIp
	PlayerTextDrawLetterSize(playerid, ThongTin[37][playerid], 0.449999, 1.600000);
	PlayerTextDrawAlignment(playerid, ThongTin[37][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[37][playerid], -1);
	PlayerTextDrawSetShadow(playerid, ThongTin[37][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[37][playerid], 1);
	PlayerTextDrawBackgroundColor(playerid, ThongTin[37][playerid], 51);
	PlayerTextDrawFont(playerid, ThongTin[37][playerid], 3);
	PlayerTextDrawSetProportional(playerid, ThongTin[37][playerid], 1);

	ThongTin[38][playerid] = CreatePlayerTextDraw(playerid, 159.199951, 278.506713, ""); //Fac
	PlayerTextDrawLetterSize(playerid, ThongTin[38][playerid], 0.449999, 1.600000);
	PlayerTextDrawAlignment(playerid, ThongTin[38][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[38][playerid], -1);
	PlayerTextDrawSetShadow(playerid, ThongTin[38][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[38][playerid], 1);
	PlayerTextDrawBackgroundColor(playerid, ThongTin[38][playerid], 51);
	PlayerTextDrawFont(playerid, ThongTin[38][playerid], 3);
	PlayerTextDrawSetProportional(playerid, ThongTin[38][playerid], 1);

	ThongTin[39][playerid] = CreatePlayerTextDraw(playerid, 158.399948, 296.426666, ""); //Rank
	PlayerTextDrawLetterSize(playerid, ThongTin[39][playerid], 0.449999, 1.600000);
	PlayerTextDrawAlignment(playerid, ThongTin[39][playerid], 1);
	PlayerTextDrawColor(playerid, ThongTin[39][playerid], -1);
	PlayerTextDrawSetShadow(playerid, ThongTin[39][playerid], 0);
	PlayerTextDrawSetOutline(playerid, ThongTin[39][playerid], 1);
	PlayerTextDrawBackgroundColor(playerid, ThongTin[39][playerid], 51);
	PlayerTextDrawFont(playerid, ThongTin[39][playerid], 3);
	PlayerTextDrawSetProportional(playerid, ThongTin[39][playerid], 1);
    ...
    // Faction TextDraw
	GroupText[0][playerid] = CreatePlayerTextDraw(playerid,501.000000, 204.000000, "");
	PlayerTextDrawBackgroundColor(playerid,GroupText[0][playerid], 255);
	PlayerTextDrawFont(playerid,GroupText[0][playerid], 3);
	PlayerTextDrawLetterSize(playerid,GroupText[0][playerid], 0.380000, 1.600000);
	PlayerTextDrawColor(playerid,GroupText[0][playerid], -1);
	PlayerTextDrawSetOutline(playerid,GroupText[0][playerid], 0);
	PlayerTextDrawSetProportional(playerid,GroupText[0][playerid], 1);
	PlayerTextDrawSetShadow(playerid,GroupText[0][playerid], 1);
	PlayerTextDrawSetSelectable(playerid,GroupText[0][playerid], 1);

    GroupText[1][playerid] = CreatePlayerTextDraw(playerid,501.000000, 215.000000, "");
	PlayerTextDrawBackgroundColor(playerid,GroupText[1][playerid], 255);
	PlayerTextDrawFont(playerid,GroupText[1][playerid], 3);
	PlayerTextDrawLetterSize(playerid,GroupText[1][playerid], 0.380000, 1.600000);
	PlayerTextDrawColor(playerid,GroupText[1][playerid], -1);
	PlayerTextDrawSetOutline(playerid,GroupText[1][playerid], 0);
	PlayerTextDrawSetProportional(playerid,GroupText[1][playerid], 1);
	PlayerTextDrawSetShadow(playerid,GroupText[1][playerid], 1);
	PlayerTextDrawSetSelectable(playerid,GroupText[1][playerid], 1);
	...
	_vhudLights[playerid] = CreatePlayerTextDraw(playerid, 495.000000, 150.000000, "~b~Den: ~r~OFF");
